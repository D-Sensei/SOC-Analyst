...
## 🛡️ The Security Operations Center (SOC) Workflow


### Behind-the-Scenes Threat Detection and Response Workflow
![](https://github.com/D-Sensei/SOC-Analyst/blob/main/Section%201%3A%20SOC%20Fundamentals/Images/soc%2Bworkflow%2Bobj.png)
- Data Collection
...
![](https://github.com/D-Sensei/SOC-Analyst/blob/main/Section%201:%20SOC%20Fundamentals/Images/siem1.png?raw=true)<br>
In this SS, we could see logs with column heads 


- Time: When and at what time the event occurred
- Name: Title pretty much describes the event
- Severity: Basically, it's a priority list.<br> Preferred **Critical**>**High**>**Medium**>**Low**
- Status: As no action is taken, it's awaiting and open. The one we resolved says “closed”
- Verdict: Conclusion given by us-> True Alert or False Alert
- Assignee: The one who took over the event to resolve
- Actions


**Scenario**: While downloading, it looked like a PDF file, but it's an executable file <br>
**Host**: Laptop no 9 from the HR dept, which is used by S.Conway, downloaded this file from Chrome<br>
**Target File**: Cat2025.mp4.exe (this person downloaded this video thinking it's a cat video, but it's an executable)<br>
**FileMD5**: Check this hash over threat int 

Contact the person and make them delete this file, and investigate how they came across it

-----

## 3\. Alert Triage (Tier 1 Focus) 🚨
...
### Scenario Example
![](https://github.com/D-Sensei/SOC-Analyst/blob/main/Section%201:%20SOC%20Fundamentals/Images/siem2.png?raw=true)
...
## 4\. Incident Investigation (Tier 2/3 Focus) 🔎

This phase is a deep dive into escalated alerts to confirm and understand the scope of a true security incident.
![](https://github.com/D-Sensei/SOC-Analyst/blob/main/Section%201:%20SOC%20Fundamentals/Images/socworkflow.png?raw=true)
